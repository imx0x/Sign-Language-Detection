...
class Application:
    def __init__(self):
        ...
        self.json_file_dru = open(self.directory+"model\model-bw_dru.json" , "r")
        self.model_json_dru = self.json_file_dru.read()
        self.json_file_dru.close()
        self.loaded_model_dru = model_from_json(self.model_json_dru)
        self.loaded_model_dru.load_weights("model\model-bw_dru.json")

        self.json_file_tkdi = open(self.directory+"model\model-bw_tkdi.json" , "r")
        self.model_json_tkdi = self.json_file_tkdi.read()
        self.json_file_tkdi.close()
        self.loaded_model_tkdi = model_from_json(self.model_json_tkdi)
        self.loaded_model_tkdi.load_weights(self.directory+"model\model-bw_tkdi.h5")

        self.json_file_smn = open(self.directory+"model\model-bw_smn.json" , "r")
